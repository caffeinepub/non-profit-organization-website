...
import type { DonationRecord as _DonationRecord, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllDonationRecords(): Promise<Array<DonationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDonationRecords();
    ...
    async getDonationRecordsByAmount(): Promise<Array<DonationRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDonationRecordsByAmount();
                return from_candid_vec_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordDonation(arg0: DonationRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordDonation(to_candid_DonationRecord_n13(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DonationRecord_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DonationRecord): DonationRecord {
...
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DonationRecord>): Array<DonationRecord> {
    return value.map((x)=>from_candid_DonationRecord_n4(_uploadFile, _downloadFile, x));
}
function to_candid_DonationRecord_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DonationRecord): _DonationRecord {
